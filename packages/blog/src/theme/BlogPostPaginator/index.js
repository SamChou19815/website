      ...
      <div className="pagination-nav__item">
        {githubSourceLink && (
          <Link className="pagination-nav__link" to={githubSourceLink}>
            <h5 className="pagination-nav__link--sublabel">Source Code</h5>
            <h4 className="pagination-nav__link--label">Read on GitHub</h4>
          </Link>
        )}
      </div>
      <div className="pagination-nav__item">
        {prevItem && (
          <Link className="pagination-nav__link" to={prevItem.permalink}>
            ...
            <h4 className="pagination-nav__link--label">&laquo; {prevItem.title}</h4>
          </Link>
        )}
      </div>
      <div className="pagination-nav__item pagination-nav__item--next">
        {nextItem && (
          <Link className="pagination-nav__link" to={nextItem.permalink}>
            ...
            <h4 className="pagination-nav__link--label">{nextItem.title} &raquo;</h4>
          </Link>
        )}
      </div>
    </nav>
